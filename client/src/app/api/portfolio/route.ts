...
import { Project, Resume, Skill, Education, Experience, Technology } from "@/models/Portfolio";

export async function GET() {
  try {
    await connectDB();

    const [projects, resume, skills, education, experience, technologies] = await Promise.all([
